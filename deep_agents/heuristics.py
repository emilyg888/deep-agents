...
THEME_LIBRARY: tuple[ThemeBlueprint, ...] = (
    ThemeBlueprint(
        theme="Shift from GenAI pilots to governed financial-services workflows",
        keywords=(
            "genai",
            "generative ai",
            "financial services",
        ...
        why_selected="The source set clusters around banks and insurers moving GenAI from experiments into regulated operating workflows.",
        why_debatable="Many leaders still treat adoption as a productivity rollout. Strong architects will debate whether workflow control is now the real adoption metric.",
        common_belief="Financial services GenAI adoption succeeds when enough employees use copilots and assistants.",
        contrarian_view="The real adoption signal is whether GenAI survives model risk, audit, escalation, and workflow ownership.",
        why_wrong="Usage-based adoption is wrong because it counts activity before proving the operating model can absorb regulated AI decisions.",
        recommendation="Treat GenAI adoption as governed workflow change with explicit control points, review gates, and accountable owners.",
        enterprise_implication="This shifts banking and insurance programs from pilot theater toward operating designs that can scale under supervision.",
        debate_score=5,
        contrarian_score=5,
    ...
    ThemeBlueprint(
        theme="Banks and insurers need adoption gates before automation depth",
        keywords=(
            "bank",
            "banks",
            "insurer",
        ...
        why_selected="The papers and news point to adoption pressure, but the recurring constraint is controlled expansion in regulated workflows.",
        why_debatable="Product teams often push deeper automation once early pilots work. Risk teams will argue that gates must come first.",
        common_belief="Once a GenAI use case works in pilot, banks and insurers should automate more of the workflow.",
        contrarian_view="Adoption should deepen only after review gates, escalation rules, and rollback paths are proven.",
        why_wrong="Pilot success is misleading because it hides exception handling, audit evidence, and accountability gaps.",
        recommendation="Stage GenAI adoption by control maturity rather than by automation ambition.",
        enterprise_implication="This makes financial services adoption slower at first but more survivable when regulators, customers, and auditors examine it.",
        debate_score=5,
        contrarian_score=5,
        decisiveness_score=5,
        tension_score=5,
